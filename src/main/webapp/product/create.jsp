...
<form method="post">
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td><input type="text" name="productColor" size="20"></td>
            <td><input type="text" name="productDescription" size="20"></td>
            <td><input type="text" name="productCategoryId" size="20"></td>
        </tr>
        <tr>
            <td colspan="6"><input type="submit" value="Submit" onclick=""></td>
        </tr>
    </table>
</form>
</body>
